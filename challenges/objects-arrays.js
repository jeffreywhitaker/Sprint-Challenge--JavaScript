...
let uni = [];
uni = graduates.filter(graduates => {
...
let lowerCase = [];
lowerCase = zooAnimals.map(arrayItem => {
...
*/
let lowerPopulation = [];
lowerPopulation = zooAnimals.filter(arrayItem => {
...
populationTotal = zooAnimals.reduce((acc, currentItem) => {
